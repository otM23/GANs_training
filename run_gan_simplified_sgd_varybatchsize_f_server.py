# -*- coding: utf-8 -*-
"""
Created on Thu Feb 11 20:49:03 2021
...
if __name__ == '__main__':
    ...
    config_files = [
            [16, 'configs/Custom_binary/lenet_sgd_16_reduced_CustomData.json'],
            [32, 'configs/Custom_binary/lenet_sgd_32_reduced_CustomData.json'],
            [64, 'configs/Custom_binary/lenet_sgd_64_reduced_CustomData.json'],
            [128, 'configs/Custom_binary/lenet_sgd_reduced_CustomData.json'],
            [256, 'configs/Custom_binary/lenet_sgd_256_reduced_CustomData.json']
            ]
    
    for bs, config_optim  in config_files:
        ...
        pd.DataFrame(df_sgd_reduced_gan).to_csv('result/sgd_reduced_gan_50_rungansgdsimplified_batch_' + str(bs) + '.csv')
